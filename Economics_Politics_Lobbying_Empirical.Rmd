...
#Firm Exposure below results in 0 for All Values of Never-Lobbying Firms 
...
#Obtaining 1 standard deviation value from predicted Log(Lobbying Expenditures) attributable to the instrument:
...
estimate_sd_effect <- function(boot_data) {
  ...
  # Second stage with bootstrapped IMR
...
#Test to ensure computational correctness of above bootstrap prior to loop
...
# Bootstrap of Local Average Treatment Effect and Estimated Net Observed Effect on Tax Revenues from Firms in the Sample
...
#Note, to increase computational time, only using the IMR formula above for selected firms (Lobbying.Expenditures > 0) given subsequent truncating of sample into only firms with Lobbying.Expenditures > 0
