...
#Pearson Correlation to Test for potential unobserved confounding relationship between effects of tax policy and percentage shifts in non-industry lobbying.

#Lobbying Firms

correlation_current <- cor(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share*100, CurrentLobbyingAccounting$Income.Taxes...Current)

correlation_paid <- cor(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share*100, CurrentLobbyingAccounting$Income.Taxes.Paid)

correlation_benefits <- cor(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share*100, CurrentLobbyingAccounting$Unrecog..Tax.Benefits...End.of.Year)



# Create the scatter plots with ggplot2
ggplot(data = CurrentLobbyingAccounting, aes(x = Non.Firm.Specific.Shift.Share*100, y = Income.Taxes...Current)) +
  geom_point() +  # Add points
  geom_smooth(method = "lm", color = "red", linetype = "dashed") +  
  annotate("text", x = min(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share*100), y = max(CurrentLobbyingAccounting$Income.Taxes...Current), label = paste("Correlation = ", round(correlation_current, 3)), 
           hjust = 0, vjust = 1, size = 5, color = "black") +  # Add correlation text to plot
  theme_minimal() +
  labs(title = "Income Taxes Current and Corresponding ∆% Non-Industry Lobbying", x = "∆% Non-Industry Lobbying", y = "Income Taxes Current ($M)")


ggplot(data = CurrentLobbyingAccounting, aes(x = Non.Firm.Specific.Shift.Share*100, y = Income.Taxes.Paid)) +
  geom_point() +  # Add points
  geom_smooth(method = "lm", color = "red", linetype = "dashed") +  
  annotate("text", x = min(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share*100), y = max(CurrentLobbyingAccounting$Income.Taxes.Paid), label = paste("Correlation = ", round(correlation_paid, 3)), 
           hjust = 0, vjust = 1, size = 5, color = "black") +  # Add correlation text to plot
  theme_minimal() +
  labs(title = "Income Taxes Paid and Corresponding ∆% Non-Industry Lobbying", x = "∆% Non-Industry Lobbying", y = "Income Taxes Paid ($M)")

ggplot(data = CurrentLobbyingAccounting, aes(x = Non.Firm.Specific.Shift.Share*100, y = Unrecog..Tax.Benefits...End.of.Year)) +
  geom_point() +  # Add points
  geom_smooth(method = "lm", color = "red", linetype = "dashed") +  
  annotate("text", x = min(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share*100), y = max(CurrentLobbyingAccounting$Unrecog..Tax.Benefits...End.of.Year), label = paste("Correlation = ", round(correlation_benefits, 3)), 
           hjust = 0, vjust = 1, size = 5, color = "black") +  # Add correlation text to plot
  theme_minimal() +
  labs(title = "Unrecognized Tax Benefits and Corresponding ∆% Non-Industry Lobbying", x = "∆% Non-Industry Lobbying", y = "Unrecognized Tax Benefits ($M)")





cor.test(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share, CurrentLobbyingAccounting$Income.Taxes...Current, method = "pearson")

cor.test(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share, CurrentLobbyingAccounting$Income.Taxes.Paid, method = "pearson")

cor.test(CurrentLobbyingAccounting$Non.Firm.Specific.Shift.Share, CurrentLobbyingAccounting$Unrecog..Tax.Benefits...End.of.Year, method = "pearson")



#Results: No evidence of visible correlations between percentage shifts in non-industry lobbying and general tax outcomes across lobbying firms


#Presenting Correlation Results as Violin Plots

library(ggplot2)
library(scales)

ggplot(CurrentLobbyingAccounting, aes(x = as.factor(Non.Firm.Specific.Shift.Share*100), y = Income.Taxes.Paid)) +
  geom_violin(fill = "lightblue") +
  geom_boxplot(width = 0.2, fill = "white") +
  labs(title = "Spearman Correlation - ∆% Non-Industry Lobbying and Income Taxes Paid",
       x = "∆% Non-Industry Lobbying", y = "Income Taxes Paid ($M)") +
scale_x_discrete(
    labels = function(x) {
      # Format numeric labels to 2 decimal places
      format(as.numeric(x), digits = 1)  # or use round(as.numeric(x), 2)
    }
  ) +
  theme_minimal()

ggplot(CurrentLobbyingAccounting, aes(x = as.factor(Non.Firm.Specific.Shift.Share*100), y = Income.Taxes...Current)) +
  geom_violin(fill = "lightblue") +
  geom_boxplot(width = 0.2, fill = "white") +
  labs(title = "Spearman Correlation - ∆% Non-Industry Lobbying and Income Taxes Current",
       x = "∆% Non-Industry Lobbying", y = "Income Taxes Current ($M)") +
scale_x_discrete(
    labels = function(x) {
      # Format numeric labels to 2 decimal places
      format(as.numeric(x), digits = 1)  # or use round(as.numeric(x), 2)
...
ggplot(CurrentLobbyingAccounting, aes(x = as.factor(Non.Firm.Specific.Shift.Share*100), y = Unrecog..Tax.Benefits...End.of.Year)) +
  geom_violin(fill = "lightblue") +
  geom_boxplot(width = 0.2, fill = "white") +
  labs(title = "Spearman Correlation - ∆% Non-Industry Lobbying and Unrecognized Tax Benefits",
       x = "∆% Non-Industry Lobbying", y = "Unrecognized Tax Benefits ($M)") +
scale_x_discrete(
    labels = function(x) {
      # Format numeric labels to 2 decimal places
      format(as.numeric(x), digits = 1)  # or use round(as.numeric(x), 2)
